...
app.get("/", async function(req, res){
    let apiUrl = `https://api.unsplash.com/photos/random/?client_id=G_N7YkH8BXPTDx7Sv6WtGRoJQqKYkNB_sTquzDPsPxk&featured=true`;
...
app.get("/search", async function(req, res){
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=G_N7YkH8BXPTDx7Sv6WtGRoJQqKYkNB_sTquzDPsPxk&featured=true&orientation=landscape&query=${keyword}`;
    let response = await fetch(apiUrl);
    let data = await response.json();
